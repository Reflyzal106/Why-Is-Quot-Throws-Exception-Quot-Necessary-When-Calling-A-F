# [SOLVED] Why-Is-Quot-Throws-Exception-Quot-Necessary-When-Calling-A-F
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/why-is-quot-throws-exception-quot-necessary-when-calling-a-f)
>
...
The 'throws' keyword in Java is necessary to declare methods that may throw checked exceptions, which are exceptions that are not caught by a try-catch block.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/why-is-quot-throws-exception-quot-necessary-when-calling-a-f)**
